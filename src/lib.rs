...
#[derive(Debug)]
pub struct AuraBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AuraBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AuraBridge processing");
    
    let mut processor = AuraBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AuraBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AuraBridgeProcessor::new(false);
